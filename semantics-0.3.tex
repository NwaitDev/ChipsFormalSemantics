...
Dans le cours d'Architecture des Ordinateurs proposé aux étudiants de Licence 2, on introduit l'utilisation de portes logiques pour la conception d'unités logico-arithmétiques. Ce rapport très matériel aux algorithmes permet de lier les aspects concrets de l'électronique à l'efficacité en temps et en espace des processeurs embarqués par nos ordinateurs. Cependant, l'intérêt de cette approche ne s'arrête pas là et des langages de plus haut niveaux basés sur ce concept de portes logiques existent : Les Langages Synchrones.
Cette présentation a pour but de donner un apperçu du panorama des langages synchrones, de leur utilisation et de concevoir quelques programmes simples suivant ce paradigme.
